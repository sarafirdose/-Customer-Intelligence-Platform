# Customer Segmentation Profiles Report
...
- **Average Tenure**: 48.0 months
- **Average Churn Risk**: 37.6%
...
- **Average Tenure**: 26.0 months
- **Average Churn Risk**: 31.2%
- **Top Contract Type**: Month-to-month
...
- **Average Tenure**: 2.6 months
- **Average Churn Risk**: 83.1%
- **Top Contract Type**: Month-to-month
- **Top Payment Method**: Electronic check
- **Recommended Marketing Campaign**: Contract Extension Upgrade Campaigns
