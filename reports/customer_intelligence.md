# Unified Subscriber Intelligence scoring Methodology

The Unified **Subscriber Intelligence Score (0-100)** is computed as a weighted index of value and risk metrics:
