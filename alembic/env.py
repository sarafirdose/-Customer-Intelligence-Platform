...
Loads the database URL dynamically from backend settings and configures
...
# Import all subclass models to register with Base.metadata for migrations
...
def run_migrations_online() -> None:
    ...
    context.
    """
    # Overwrite sqlalchemy.url in ini config with dynamic settings URL
